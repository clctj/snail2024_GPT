# -*- coding: utf-8 -*-
from PyQt5.QtCore import pyqtSlot,QUrl,Qt,QTimer,QStringListModel,QModelIndex,QMarginsF
from PyQt5.QtWidgets import QWidget , QApplication
from PyQt5.QtMultimedia import  QMediaPlayer , QMediaContent
from PyQt5.Qt import QThread, pyqtSignal
from PyQt5.QtGui import  QCursor, QPageLayout, QPageSize
...
class Text_win(QWidget, Ui_Text_win):
    def __init__(self , parent=None):#作为上层场景的一个窗口
        ...
        self.roleList=['你是我的老师，请根据关键词，帮我解答问题，解答之前，先复述我的问题，你可以理解我的意思么？', 
                       '你是写作助理，请根据我下面讲给你的关键词，写一片短文，解答之前，先复述我的问题，你可以理解我的意思么？', 
                       '你是出题人，请根据我的请求，出题考我，每次一题，解答之前，先复述我的问题，你可以理解我的意思么？', 
                       '你是翻译官，请根据我的要求进行中英文互译。解答之前，先复述我的问题，你可以理解我的意思么？',
                       '你是语文老师，请帮我润色优化作文，不要全文照抄，先输出我的原文，换行后，输出你优化的作文。理解了请复述我的要求。', 
                       '你是唐朝状元郎，请帮我把短文翻译成文言文。解答之前，先复述我的问题，你可以理解我的意思么？' 
                       ]#提示词列表，这里要调整为动态添加提示词
    ...
    def on_listView_clicked(self, index):
        ...
        </html>""".format(self.user_contents[index], markdown.markdown(self.assistant_contents[index]))
    ...
    def format_answer(self, answer):
        ...
        '<html><body>'
        '<img src=":/snail/qrc/gpt_man.png" />: {}'
        '</body></html>'.format(markdown.markdown(formatted_answer)))#用户提示词+GPT输出
        ...
        </html>""".format( markdown.markdown(formatted_answer).strip())
        self.answer_Text.setHtml(answer_html)
        #通用按钮
...
class Ixinhuo(QWidget):#讯飞星火模型
    ...
    def send_msg(self, question):#发送列表信息到轮子SparkApi(星火到模型提供的轮子）
        ...
        question.insert(0, {'role': 'system', 'content':'文本使用Markdown格式，公式使用Latex格式输出。'})#叠加提示语
